...
CREATE TABLE Venta (
    ...
    Fecha DATE NOT NULL,
    CodigoProducto INT,
    CodigoVentaRelacionado INT, -- Clave for�nea autorreferencial
...
(18, 'Bater�as port�tiles'),
(19, 'Altavoces Bluetooth'),
(20, 'Accesorios para autom�viles');
...
(96, 'Soporte magn�tico para celular', 20),
(97, 'Cargador USB para auto', 20),
(98, 'Transmisor FM Bluetooth', 20),
(99, 'C�mara de reversa', 20),
